  ...
  function TransactionValidatorService ($timeout, dialogService, gettextCatalog, utilityService, accountService, networkService, toastService, transactionBuilderService) {
    const openDialogIn = ($scope, selectedAccount, transactions) => {
      ...
      $scope.validate = {
        ...
        transactions,
        humanAmount: utilityService.phantomtoshiToPhantom(amount).toString(),
        totalFees: utilityService.phantomtoshiToPhantom(fees).toString(),
        totalAmount: utilityService.phantomtoshiToPhantom(total).toString(),
        remainingBalance: utilityService.phantomtoshiToPhantom(balance).toString()
      }
