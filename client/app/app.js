...
const modules = [
  ...
  'monospaced.qrcode',
  'infinite-scroll',
  'phantomclient.filters',
  'phantomclient.services',
  'phantomclient.components',
  'phantomclient.directives',
  'phantomclient.accounts',
  'phantomclient.constants'
]

const app = angular.module('phantomclient', modules)
