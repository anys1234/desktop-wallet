...
describe('transactionSenderService', () => {
  describe('openDialogIn()', () => {
    ...
    beforeEach(() => {
      module('phantomclient.accounts', $provide => {
        accountServiceMock = {
        ...
        networkServiceMock = {
          ...
          getNetwork () { return { theme: 'default', themeDphantom: false } },
          getNetworks () {},
      ...
      module('phantomclient.services', $provide => {
    ...
    context('single transaction', () => {
      ...
      context('when the form amount is a float', () => {
        it('uses the right amount to build it', () => {
          ...
          // @see https://github.com/PhantomCore/phantom-desktop/issues/385
