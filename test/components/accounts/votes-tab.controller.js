...
describe('VotesTabController', () => {
  const MOCK_DELEGATE = {
    address: 'mockDelegatePhantomAddress',
    approval: 89.09,
    missedblocks: 9760,
  ...
  beforeEach(() => {
    ...
    module('phantomclient.components', $provide => {
      ...
      $provide.value('PHANTOMTOSHI_UNIT', Math.pow(10, 8))
      $provide.value('PHANTOM_LAUNCH_DATE', new Date(Date.UTC(2017, 2, 21, 13, 0, 0, 0)))
